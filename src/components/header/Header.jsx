...
const Header = () => {
    ...
    return <>
        ...
        <header className="d-flex justify-content-between pt-4  ">
            <div className="menu  align-items-center justify-content-center" onClick={() => {
                setResponse(true)
            }}>
            ...
            <div className='mood d-flex align-items-center justify-content-center' onClick={() => {
                localStorage.setItem("currentMood", theme === "dark" ? "light" : "dark")
                setTheme(localStorage.getItem("currentMood"))
            }} >{theme === "dark" ? <i className="fa-regular fa-moon"></i> : <i className="fa-regular fa-sun"></i>}</div >
            {response && (
                <div className="overlay">
                    <div className="list mt-5 position-absolute p-3  ">
                        <ul className=" p-0">

                            <div className="close text-end " onClick={() => {
                                setResponse(false)
                            }}>
