        ...
        <div className="row">
          <div className="col-md-7">
            <div>
              ...
              <p>Electronics and Communication Engineer / Frontend Developer.</p>

              <div className="social d-flex gap-4 mt-4">
                <a href="https://github.com/Mhmd-Ataa">
                  <i className="fab fa-github"></i>
                </a>
                <a href="https://www.linkedin.com/in/muhammad-ataa-62b52823a?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app">
